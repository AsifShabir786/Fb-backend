const Group = require('../model/Pages');
const Post = require('../model/Pages');
const response = require('../utils/responceHandler');

// Create Group
const createGroup = async (req, res) => {
  try {
    const { pageName, description,userId } = req.body;
...
const createPost = async(req,res) =>{
  try {
      ...
      const {content,groupId,userId,groupName,pages,isFeatured} = req.body;
      const file= req.file;
      let mediaUrl = null;
      let mediaType = null;
